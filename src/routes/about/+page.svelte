...
<main>
	<div class="container py-4">
		...
		<div class="row align-items-md-stretch">
			<div class="col-md-6">
				<div class="h-100 bg-dark rounded-3 p-5 text-white">
			...
			<div class="col-md-6">
				<div class="h-100 bg-light rounded-3 border p-5">
					<h2>Add borders</h2>
					<p>
		...
		<footer class="border-top mt-4 pt-3 text-muted">&copy; 2021</footer>
	</div>
</main>
